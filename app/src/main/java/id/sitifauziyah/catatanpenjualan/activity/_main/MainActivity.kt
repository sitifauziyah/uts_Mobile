package id.sitifauziyah.catatanpenjualan.activity._main
...
import id.sitifauziyah.catatanpenjualan.activity._main.adapter.MenuAdapter
import id.sitifauziyah.catatanpenjualan.activity._main.presenter.MainPresenter
import id.sitifauziyah.catatanpenjualan.activity._main.presenter.MainView
import id.sitifauziyah.catatanpenjualan.activity.data_barang.DataBarangActivity
import id.sitifauziyah.catatanpenjualan.activity.login.LoginActivity
import id.sitifauziyah.catatanpenjualan.activity.penjualan.PenjualanBarang
import id.sitifauziyah.catatanpenjualan.activity.report.ReportActivity
import id.sitifauziyah.catatanpenjualan.base.BaseActivity
import id.sitifauziyah.catatanpenjualan.model.Keranjang
import id.sitifauziyah.catatanpenjualan.utils.Uang
