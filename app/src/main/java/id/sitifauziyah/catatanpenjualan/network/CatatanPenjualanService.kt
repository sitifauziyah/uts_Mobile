package id.sitifauziyah.catatanpenjualan.network

import id.sitifauziyah.catatanpenjualan.activity.data_barang.data.ResultDataBarang
import id.sitifauziyah.catatanpenjualan.activity.login.data.ResultLogin
import id.sitifauziyah.catatanpenjualan.activity.penjualan.data.ResultKeranjang
import id.sitifauziyah.catatanpenjualan.activity.penjualan.data.ResultSearchBarang
import id.sitifauziyah.catatanpenjualan.activity.report.detail.data.ResultItemKeranjang
import id.sitifauziyah.catatanpenjualan.response.ResultSimple
